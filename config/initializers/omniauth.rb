Rails.application.config.middleware.use OmniAuth::Builder do
  ...
  provider :google_oauth2, '558250518047-f0hg8vqhhtvljvk0ka461sp1rjmokiol.apps.googleusercontent.com', '2sFT92P8R84Dww8N8nq6rr0R', scope: 'profile', access_type: 'online', name: 'google'
